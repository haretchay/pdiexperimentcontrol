  ...
  const result = await Promise.all(
    (tests ?? []).map(async (t: any) => {
      ...
      return {
        ...
        merged: {
          day7: p7 ? { storagePath: p7.storage_path, url: url7, createdAt: p7.created_at } : null,
          day14: p14 ? { storagePath: p14.storage_path, url: url14, createdAt: p14.created_at } : null,
        },
      }
    })
  )
